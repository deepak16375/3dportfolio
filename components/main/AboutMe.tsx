...
const AboutMe = () => {
  return (
    <section
      className=" w-full min-h-screen flex flex-col items-center z-40 gap-36"
      id="about-me"
    >
      ...
      <motion.div
        ...
        whileInView="visible"
        viewport={{ once: true }}
        className="h-full w-full flex flex-col justify-center items-center z-50  gap-10 "
      >
        ...
        <div className=" h-full w-1/2 z-50 text-gray-300 flex flex-col gap-4  ">
          <p className="  text-xl  text-center">
            A passionate front-end developer from India.📍
          </p>
          <p className=" text-center lg:text-xl text-gray-300  p-10 max-sm:p-0">
